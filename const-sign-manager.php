...
$json =<<<CONFIG
  ...
  IMAGE_SIGNATURE_TYPE_LIST_QR_DESCRIPTION: "Scan a QR Code using any mobile device to open a page where you can draw your signature. Your signature will appear in the Signature Wizard and ready for use.",
  IMAGE_SIGNATURE_TYPE_LIST_SMS_TITLE: "<b>Use Mobile via SMS</b>",
  IMAGE_SIGNATURE_TYPE_LIST_SMS_DESCRIPTION: "When you use this option, <strong>PDFfiller</strong> sends you a link via SMS. Just tap that link to easily draw a signature on your mobile device. Your signature will appear in the Signature Wizard and ready for use.",
  IMAGE_SIGNATURE_TYPE_LIST_EMAIL_TITLE: "<b>Use Mobile via Email</b>",
  IMAGE_SIGNATURE_TYPE_LIST_EMAIL_DESCRIPTION: "When you use this option, PDFfiller sends you a link via Email. Just tap that link on your mobile device to easily draw a signature right there. Your signature will appear in the Signature Wizard and ready for use.",
  IMAGE_SIGNATURE_TYPE_LIST_UPLOAD_TITLE: "<b>Upload</b>",
  IMAGE_SIGNATURE_TYPE_LIST_UPLOAD_DESCRIPTION: "Easily upload the image of your signature from a computer. Your uploaded signature will appear in the Signature Wizard and ready for use.",
  IMAGE_SIGNATURE_TYPE_LIST_CAMERA_TITLE: "<b>Capture</b>",
  IMAGE_SIGNATURE_TYPE_LIST_CAMERA_DESCRIPTION: "Allow the access to your camera and take a photo of your signature. Just sign the paper and show to the camera, so your signature fits inside the box and click Take Snapshot. Your signature will appear in the Signature Wizard and ready for use.",
